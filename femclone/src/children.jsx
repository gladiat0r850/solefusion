...
function KidSection({shoes}){
  ...
  return <>
    ...
    {kidSection.filter(item => item.kidEligable == true).map((item, index) => {return <div className='h-auto w-96 rounded-lg flex items-center pb-5 gap-12 justify-center cursor-pointer flex-col bg-[#ececec]'>
