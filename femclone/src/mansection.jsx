...
function Mansection({shoes}) {
  ...
  return <>
    ...
    {filtration.filter(item => item.gender === 'Men').map((item, index) => {return <div className='h-auto w-96 rounded-lg flex items-center pb-5 gap-12 justify-center cursor-pointer flex-col bg-[#ececec]'>
